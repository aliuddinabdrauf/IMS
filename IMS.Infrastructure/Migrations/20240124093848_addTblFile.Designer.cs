...
namespace IMS.Infrastructure.Migrations
{
    ...
    [Migration("20240124093848_addTblFile")]
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "account_type", new[] { "all", "student", "staff", "industry" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "file_type", new[] { "image", "document" });
            ...
            modelBuilder.Entity("IMS.Infrastructure.DbContext.IMS.TblFile", b =>
                {
                    b.HasBaseType("IMS.Infrastructure.DbContext.IMS.TblBase");
            ...
            modelBuilder.Entity("IMS.Infrastructure.DbContext.IMS.TblLoginSession", b =>
                {
                    ...
                    b.Property<Instant>("TimestampLatestActivity")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("timestamp_latest_activity");
            ...
            modelBuilder.Entity("IMS.Infrastructure.DbContext.IMS.TblUser", b =>
                {
                    ...
                    b.HasIndex("ProfilePicture")
                        .IsUnique()
                        .HasDatabaseName("ix_tbl_user_profile_picture");

                    b.ToTable("tbl_user", (string)null);
                });

            modelBuilder.Entity("IMS.Infrastructure.TblFileDetail", b =>
                {
                    b.HasBaseType("IMS.Infrastructure.DbContext.IMS.TblBase");

                    b.Property<Guid>("Actual")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("Actual")
                        .HasDatabaseName("ix_tbl_file_detail_actual");

                    b.HasIndex("Preview")
                        .HasDatabaseName("ix_tbl_file_detail_preview");

                    b.ToTable("tbl_file_detail", (string)null);
                });
            ...
            modelBuilder.Entity("IMS.Infrastructure.DbContext.IMS.TblUser", b =>
                {
                    b.HasOne("IMS.Infrastructure.TblFileDetail", "ProfilePitcureFile")
                        .WithOne("User")
                        .HasForeignKey("IMS.Infrastructure.DbContext.IMS.TblUser", "ProfilePicture")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_tbl_user_tbl_file_details_profile_picture");

                    b.Navigation("ProfilePitcureFile");
                });

            modelBuilder.Entity("IMS.Infrastructure.TblFileDetail", b =>
                {
                    b.HasOne("IMS.Infrastructure.DbContext.IMS.TblFile", "FileActual")
                        .WithMany("Actuals")
                        .HasForeignKey("Actual")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired()
                        .HasConstraintName("fk_tbl_file_detail_tbl_file_actual");

                    b.HasOne("IMS.Infrastructure.DbContext.IMS.TblFile", "FilePreview")
                        .WithMany("Previews")
                        .HasForeignKey("Preview")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_tbl_file_detail_tbl_file_preview");

                    b.Navigation("FileActual");
